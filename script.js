$(document).ready(function () {
     ...
     */
    var content = [{
        title: "I'm so sorry for all",
        desc: ""
    }, {
        title: "I'm so sorry",
        desc: "maaf ya udah buat kamu ga nyaman, risih, sampai  tersebarnya masalah kerahasiaan kita."
    }, {
       title: "",
       desc: "hehehe kalau buat besok kamu memang gabisa, gpp kok jangan dipaksa juga kalo gabisa. kalau ditanya kenapa kok segitunya mau ngasih gift padahal baru aja kenal. Aku juga bingung, cuman yg bisa aku bilang 'suka aja ngelakuin apa aja buat kamu, apalagi kalau dengan gift ku bisa bikin kamu seneng'. "
    }, {
        title: "",
        desc: "Kalau Kamu Risih Bilang yahh, Kalau kamu Terganggu Bilang yaaa. Sejak awal aku ga expect kalo dm aku bakal dibales sama kamuu, apalagi sampe bisa jadi temen cerita kamu kalo boleh bilang 'AKU SENENG BANGETTTT'. Semangat nge-drakor nyaa . semangatt kalau lagii main jangan pulang malam-malam yaa sama jangan lupa pake hoodie/jaket/sweater nanti masuk angin loo meskipun angin aja kalah kebal sama kamu"
    }, {
        title: "I'M SO SORRY YA MARSYAAA",
        desc: "Aku tunggu Balasan Mu:). kalau tadi kamu cuman baca 2 slide coba kamu slide mundur soalnya tadi aku bikin 3, hehhe maap maap masih belom jago"
 }];
    var currentPage = 0;
    //generate content
